                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            do
                                NAME="UNCGAN"_"$TYPE"
                                LOGGINGNAME=_"UNCGAN"_"$TYPE"+"Glr"_"$OPT_G"+"Dlr"_"$OPT_D"
                                jq --arg a "$NAME" '.name = $a' ./config/config_UNCGAN_HParamTune.json | sponge ./config/config_UNCGAN_HParamTune.json
                                jq --arg a "$LOGGINGNAME" '.run_name = $a' ./config/config_UNCGAN_HParamTune.json | sponge ./config/config_UNCGAN_HParamTune.json
                                ...
                                -c ./config/config_UNCGAN_HParamTune.json\
                                # --opt_G "$OPT_G"\
                                # --opt_D "$OPT_D"\
                                # --ngf "$ngf"\
                                # --ndf "$ndf"\
