                ...
                do
                    ...
                    do
                        ...
                        do
                            for nz in ${NZ[@]}
                            do
                                NAME="UNCTransGAN_Noise"_"$TYPE"
                                LOGGINGNAME=_"UNCTransGAN_Noise"_"$TYPE"+"Glr"_"$OPT_G"+"Dlr"_"$OPT_D"
                                jq --arg a "$NAME" '.name = $a' ./config/config_UNCTransGAN_HParamTune.json | sponge ./config/config_UNCTransGAN_HParamTune.json
                                jq --arg a "$LOGGINGNAME" '.run_name = $a' ./config/config_UNCTransGAN_HParamTune.json | sponge ./config/config_UNCTransGAN_HParamTune.json
                                ...
                                -c ./config/config_UNCTransGAN_HParamTune.json\
                                # --opt_G "$OPT_G"\
                                # --opt_D "$OPT_D"\
                                # --ngf "$ngf"\
                                # --ndf "$ndf"\
