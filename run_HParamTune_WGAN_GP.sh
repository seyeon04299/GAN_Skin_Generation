                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            do
                                NAME="WGANGP"_"$TYPE"
                                LOGGINGNAME=_"WGANGP"_"$TYPE"+"Glr"_"$OPT_G"+"Dlr"_"$OPT_D"+"Gngf"_"$ngf"+"Dndf"_"$ndf"+"NZ"_"$nz"
                                jq --arg a "$NAME" '.name = $a' ./config/config_WGANGP_HParamTune.json | sponge ./config/config_WGANGP_HParamTune.json
                                jq --arg a "$LOGGINGNAME" '.run_name = $a' ./config/config_WGANGP_HParamTune.json | sponge ./config/config_WGANGP_HParamTune.json
                                ...
                                -c ./config/config_WGANGP_HParamTune.json\
                                --opt_G "$OPT_G"\
                                --opt_D "$OPT_D"\
                                --ngf "$ngf"\
                                --ndf "$ndf"\
